                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-8">
                    <div className="max-w-2xl">
                        <div className="inline-flex items-center gap-2 px-3 py-1 bg-white/5 rounded-full border border-white/10 mb-6">
                            ...
                            <span className="text-xs font-medium text-gray-300">VELORA AI AGENTS</span>
                        </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {agents.map((agent, i) => (
                        <motion.div
                            key={i}
                            whileHover={{ y: -5 }}
                            className="bg-black border border-white/10 p-8 rounded-2xl hover:border-white/20 transition-all"
                        >
                            <div className={`w-12 h-12 ${agent.color} rounded-xl flex items-center justify-center mb-6`}>
                                <agent.icon size={24} />
                            </div>
                            <h4 className="text-lg font-bold text-white mb-3">{agent.title}</h4>
