...
const comparisonData = [
  ...
  {
    feature: "Integração com o time da agência",
    freelancer: false,
  ...
  {
    feature: "Visão de negócio do cliente",
    freelancer: false,
        ...
        <div className="max-w-5xl mx-auto">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold tracking-tighter text-brand-light mb-8">
              O que muda quando o <span className="text-brand-neon">sênior é da Velora</span>
            </h2>
          </motion.div>
          ...
          >
            <button
              onClick={scrollToCTA}
              className="px-8 py-4 bg-brand-neon text-black font-semibold rounded-lg hover:bg-brand-neon/90 transition-all duration-300 flex items-center group"
            >
...
export default GlaasComparison;
