            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                >
                    ...
                    <h1 className="text-6xl md:text-8xl font-bold tracking-tighter text-brand-light mb-8 leading-[0.9]">
                        Do contato <br />
                        <span className="text-brand-neon">à carteira.</span>
                    </h1>
                    <p className="max-w-xl text-xl text-brand-light/60 mb-10 leading-relaxed font-light">
                        Ajudamos gestoras, family offices, consultorias financeiras e bancos de investimento a potencializar o trabalho do marketing na captação de clientes e na ampliação de receita da base atual.
                    </p>
...
export default MarketingFinanceiroHero;
