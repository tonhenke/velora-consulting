...
const deliverables = [
  ...
  'Modelo de perfil e priorização (ABM)',
  'Arquitetura de CRM',
  'Pipeline e critérios de gestão',
  'Modelo de expansão da base',
  'Dashboards de captação e receita',
  'Cadência de otimização'
];

const MarketingFinanceiroDeliverablesSection = () => {
  return (
          ...
          <div className="md:w-1/3">
            ...
            >
              ...
              <p className="text-lg text-brand-dark/70 font-medium mb-8">
                O que pode sair dessa leitura. Entregas práticas que mudam a forma como sua gestora ou consultoria decide e opera.
              </p>
...
export default MarketingFinanceiroDeliverablesSection;
