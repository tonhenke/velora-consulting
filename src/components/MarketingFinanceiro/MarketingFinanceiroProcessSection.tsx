...
const phases = [
  {
    ...
    title: 'Diagnóstico',
    desc: 'Onde estamos',
    details: 'Reconstruímos jornada de captação, canais, perfil de clientes, pipeline, CRM e economia da captação.'
  },
  {
    num: '02',
    title: 'Arquitetura',
    desc: 'Como estruturar',
    details: 'Definimos prioridades, etapas, métricas de captação, responsabilidades e lógica de dados.'
  },
  {
    num: '03',
    title: 'Implementação',
    desc: 'O que fazer',
    details: 'Ajustamos canais, CRM, rotinas, relatórios, perfis prioritários e processos entre marketing, comercial e backoffice.'
  },
  {
    num: '04',
    title: 'Otimização',
    desc: 'Como melhorar',
    details: 'Acompanhamos conversão, qualidade dos clientes captados, AuM e aprendizado dos testes.'
  }
];

const MarketingFinanceiroProcessSection = () => {
  return (
...
export default MarketingFinanceiroProcessSection;
