...
const questions = [
  "Sabemos de onde vêm nossas principais oportunidades de captação, além de indicação e relacionamento?",
  "Conseguimos acompanhar um prospect da primeira interação até a abertura de conta?",
  "Sabemos quais canais e ações aparecem com mais frequência antes dos melhores clientes captados?",
  "Marketing, Comercial e sócios concordam sobre quais perfis de investidor merecem prioridade?",
  "Conseguimos comparar canais de captação por taxa de conversão, ticket médio e LTV?",
  "Nos prospects prioritários, sabemos quem tem relacionamento e qual é a próxima ação?",
  "Sabemos quais clientes têm espaço real para aportar mais ou contratar outros produtos?",
  "Eventos relevantes na vida dos clientes (empresa vendida, herança, etc.) geram ação comercial estruturada?",
  "O CRM preserva histórico suficiente para analisar o passado e melhorar a captação futura?",
  "Conseguimos acompanhar o mesmo cliente entre Marketing, Comercial, backoffice e receita?"
];
...
const MarketingFinanceiroScorecardQuiz = () => {
  ...
  const calculateResult = () => {
    ...
    if (total <= 12) {
      return {
        title: "Captação por atividade",
        desc: "Existem ações de captação, mas pouca conexão entre jornada, perfil de cliente e resultado financeiro."
      };
    } else if (total <= 21) {
      return {
        title: "Captação por funil",
        desc: "A jornada já é parcialmente visível. O avanço está em atribuição, economia e priorização de perfis."
      };
    } else {
      return {
        title: "Captação por receita",
        desc: "Captação já é discutida junto com resultado. O ganho está em otimização, expansão da base e governança de dados."
      };
    }
  };
      ...
      <div className="container mx-auto px-6 max-w-4xl relative z-10">
        ...
        <div className="text-center mb-12">
          ...
          <h2 className="text-4xl md:text-5xl font-bold tracking-tighter mb-4 text-brand-dark">
            ...
            <span className="text-brand-dark/40">da próxima captação.</span>
          </h2>
          <p className="text-brand-dark/70 text-lg max-w-2xl mx-auto">
            Avalie o nível de maturidade da sua operação de captação e descubra onde o crescimento está travado.
          </p>
        </div>
...
export default MarketingFinanceiroScorecardQuiz;
