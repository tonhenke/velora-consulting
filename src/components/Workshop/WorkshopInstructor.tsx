...
const WorkshopInstructor = () => (
  <section className="py-24 md:py-32 bg-brand-dark relative overflow-hidden">
    <div className="absolute top-1/2 right-0 w-[500px] h-[500px] bg-brand-neon/5 rounded-full blur-[150px] pointer-events-none" />
    ...
    <div className="container mx-auto px-6 relative z-10">
      ...
      >
        ...
        <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tighter text-brand-light">
          Conheça seu <span className="text-brand-neon">instrutor</span>
        </h2>
      </motion.div>
      ...
      <div className="grid lg:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
        ...
        >
          ...
          <div className="relative overflow-hidden rounded-2xl border border-brand-light/10">
            <img
        ...
        >
          ...
          <p className="text-base text-brand-light/50 leading-relaxed italic mb-8">
          ...
          <div className="flex flex-wrap gap-3">
            <span className="px-4 py-2 bg-brand-neon/10 border border-brand-neon/20 rounded-full text-sm font-semibold text-brand-neon">
              +218 negócios impactados
            </span>
            <span className="px-4 py-2 bg-white/5 border border-white/10 rounded-full text-sm font-semibold text-brand-light/60">
      ...
      <motion.div
        ...
        className="mt-20"
      >
        <p className="text-center text-sm font-semibold text-brand-light/30 uppercase tracking-widest mb-8">
          Marcas que já atuei
        </p>
        <div className="flex flex-wrap items-center justify-center gap-8 md:gap-12">
          {brands.map((b) => (
            <img
              ...
              src={b.src}
              alt={b.name}
              className="h-8 md:h-10 w-auto object-contain brightness-0 invert opacity-30 hover:opacity-70 transition-opacity duration-300"
            />
          ))}
        </div>
      </motion.div>
