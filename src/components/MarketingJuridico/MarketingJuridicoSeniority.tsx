...
const differentials = [
  ...
  {
    icon: Briefcase,
    title: 'Especialistas em Jurídico Empresarial',
    description: 'Somos especialistas na complexidade da venda de serviços jurídicos de alto valor, ciclos longos, múltiplos decisores, ABM e RevOps no contexto da advocacia empresarial.'
  },
  {
    icon: Zap,
...
const MarketingJuridicoSeniority = () => {
  return (
...
export default MarketingJuridicoSeniority;
