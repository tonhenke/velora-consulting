                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
                    {channels.map((channel, i) => (
                        <motion.div
                            ...
                            className="bg-white/5 border border-white/10 rounded-xl p-6 flex flex-col items-center gap-4 transition-all duration-300 cursor-default"
                        >
                            <channel.icon className="text-gray-300" size={24} />
